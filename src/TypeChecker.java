        ...
        switch (tag) {
            ...
            case "COMMAND":// COMMAND := skip(0) | halt(0)
                if (children.get(0).getValue() != null) {
                    ...
                    // print ATOMIC
                    else if (children.get(0).getValue() != null && !children.isEmpty()
                            && children.get(0).getValue().equals("print") && children.get(1).getTag() == "ATOMIC") {
                        ...
                        // return ATOMIC
                    } else if (children.size() == 2 && children.get(0).getValue().equals("return")
                            && children.get(1).getTag().equals("ATOMIC")) { // TODO: Need help understanding this
            ...
            case "ASSIGN":// ASSIGN := VNAME(0) <(1) input(2)
                if (children.get(2).getValue() != null) {
                    ...
                    if (!children.isEmpty() && children.get(0).getTag().equals("VNAME")
                            && children.get(2).getValue().equals("input")) {
                ...
                } else if (!children.isEmpty() && children.get(0).getTag().equals("VNAME")
                        && children.get(2).getTag().equals("TERM")) {
            ...
            case "HEADER": // FTYP(0) FNAME(1) ((2) VNAME1(3) ,(4) VNAME2(5) ,(6) VNAME3(7) )(8)
                if (typeOf(children.get(3)) == typeOf(children.get(5))
                        && typeOf(children.get(5)) == typeOf(children.get(7)) && typeOf(children.get(7)) == 'n') {
                    return true;
                } else {
    ...
    public char typeOf(XMLParseTree xml) {
        ...
        switch (tag) {
            ...
            case "CALL": // CALL := FNAME(0) ((1) ATOMIC(2) ,(3) ATOMIC(4) ,(5) ATOMIC(6) )(7)
                if (typeOf(children.get(2)) == 'n' && typeOf(children.get(4)) == 'n'
                        && typeOf(children.get(6)) == 'n') {
                    return typeOf(children.get(0));
                } else {
            ...
            case "BINOP": // BINOP := or | and | eq | grt | add | sub | mul | div | not | sqrt
                ...
                if (children.get(0).getValue().equals("or") || children.get(0).getValue().equals("and")) {
                    ...
                    return 'c';
                } else if (children.get(0).getValue().equals("add") || children.get(0).getValue().equals("sub")
                        || children.get(0).getValue().equals("mul") || children.get(0).getValue().equals("div")) {
                    return 'n';
                }
                break;
            ...
            case "OP": // UNOP(0) ( (1) and ARG(2) ) (3)
                if (children.get(0).getTag().equals("UNOP")) {
                    ...
                    if ((typeOf(children.get(0)) == typeOf(children.get(2)))
                            && typeOf(children.get(2)) == typeOf(children.get(4)) && typeOf(children.get(4)) == 'b') {
                        return 'b';
                    } else if ((typeOf(children.get(0)) == typeOf(children.get(2)))
                            && typeOf(children.get(2)) == typeOf(children.get(4)) && typeOf(children.get(4)) == 'n') {
                        return 'n';
                    } else if (typeOf(children.get(0)) == 'c' && typeOf(children.get(2)) == typeOf(children.get(4))
                            && typeOf(children.get(4)) == 'n') {
                        return 'b';
                    } else {
                        return 'u';
                    }
    ...
    public boolean checkReturnInFunctionScope(XMLParseTree returnNode, XMLParseTree atomicNode) {
        ...
        while (current != null) {
            if (current.getChildren().get(0).getTag().equals("HEADER")) {
                XMLParseTree ftypNode = current.getChildren().get(0).getChildren().get(0); // Assuming FTYP is the first
                                                                                           // child in HEADER
